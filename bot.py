...
b2 = types.KeyboardButton(text="Выбрать другой самолет")
...
def f(query):
    ...
    with open("preferences.txt", "r") as f:
        data = ast.literal_eval(f.read())
    data[str(query.message.chat.id)] = '1'
...
def f(query):
    ...
    with open("preferences.txt", "r") as f:
        data = ast.literal_eval(f.read())
    data[str(query.message.chat.id)] = '2'
    with open("preferences.txt", "w") as f:
        f.write(str(data))
    bot.send_message(chat_id=query.message.chat.id, text="Готово!", reply_markup=start_menu)
...
def f(query):
    ...
    with open("preferences.txt", "r") as f:
        data = ast.literal_eval(f.read())
    data[str(query.message.chat.id)] = '3'
    with open("preferences.txt", "w") as f:
        f.write(str(data))
    bot.send_message(chat_id=query.message.chat.id, text="Готово!", reply_markup=start_menu)
...
def f(query):
    ...
    with open("preferences.txt", "r") as f:
        data = ast.literal_eval(f.read())
    data[str(query.message.chat.id)] = '4'
    with open("preferences.txt", "w") as f:
        f.write(str(data))
    bot.send_message(chat_id=query.message.chat.id, text="Готово!", reply_markup=start_menu)
